...
\label{overflow}
\end{figure}
%rich_pic_histrogram.png

The striped lines shows that a certain stakeholder, user or device is connected to the \textit{cloud}, which is connected to Rejse korts server.
